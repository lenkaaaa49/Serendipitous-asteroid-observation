...
sql = "CREATE TABLE IF NOT EXISTS INPUT_Table (\
  ...
  `Observation_date` varchar(30) NOT NULL,\
  ...
  `Time_Updated_System_timezone` TIMESTAMP,\
  `Time_Updated_UTC` varchar(30))"
...
#input dummy data
sql1= "INSERT INTO INPUT_Table (`OBS_id`,`Observation_date`,`Instrument`,`Vertex1_1`,`Vertex1_2`,`Vertex2_1`,`Vertex2_2`,`Vertex3_1`,`Vertex3_2`,`Vertex4_1`,`Vertex4_2`) VALUES ('170309_134500_M','2017/03/09 13:45:00 GMT','MIRI','22 deg','24 deg','2 deg',NULL,NULL,NULL,NULL,NULL)\
,('170809_134500_NS','2017/08/09 13:45:00 GMT','NIRSpec','22 deg','24 deg','22 deg','24.2 deg','22.1 deg','24.3 deg','22.4 deg','24 deg')\
,('181209_134500_M','2018/12/09 13:45:00 GMT','MIRI','22 deg ','24 deg','2 deg',NULL,'0.2 deg',NULL,'8 deg',NULL)"
